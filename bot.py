...
# === ТВОИ API_ID И API_HASH (ЗАШИТЫ В КОД) ===
API_ID = 38176418
API_HASH = '1e588a21b0f6d9e1b411db047fa1262a'

# === ПЕРЕМЕННЫЕ ОКРУЖЕНИЯ (задать на Render) ===
...
# Передаём валидные API_ID и API_HASH – они проигнорируются, т.к. сессия уже содержит их,
# но без них Telethon выбрасывает ошибку.
