...
# ============================================================
# МЕТОД 6: TELEGRAM BOT API (getUserGifts) — только текущие подарки
# ============================================================
# Этот метод требует прямого вызова Bot API, но у нас нет доступа к сторонним ботам.
# Оставляем как заглушку — можно реализовать через отдельного бота.
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        ...
        "Данные берутся из 5+ открытых источников.",
        parse_mode='Markdown'
    )
